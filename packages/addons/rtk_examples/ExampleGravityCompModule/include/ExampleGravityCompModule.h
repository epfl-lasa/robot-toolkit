...
#ifndef ExampleGravityCompModule_H_
#define ExampleGravityCompModule_H_

#include "RobotLib/RobotInterface.h"
#include "RobotLib/InverseDynamics.h"

class ExampleGravityCompModule : public RobotInterface
{
protected:
...
public:
            ExampleGravityCompModule();
    virtual ~ExampleGravityCompModule();
