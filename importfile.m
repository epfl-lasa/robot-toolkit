function Position = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   POSITION = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   POSITION = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   Position = importfile('Position.txt', 1, 3192);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/02/08 21:38:51
